  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      CustomScrollView(physics: BouncingScrollPhysics(), slivers: <Widget>[
        widget.sliverAppBar(_appBarBehavior, [], widget.flexibleSpaceBar('More')),
        SliverList(
                            ...
                            Navigator.push(
                                ...
                                MaterialPageRoute(
                                    builder: (context) => WebViewWidget(
                                        title: 'Point system',
                                        url: 'https://www.dream11.com/games/point-system'),
                                    fullscreenDialog: true));
                          },
                          ...
                          onTap: () {
                            Navigator.push(
                                ...
                                MaterialPageRoute(
                                    builder: (context) => WebViewWidget(
                                        title: 'How to play',
                                        url: 'https://www.supersmash.co.nz/news-videos/the-dream11-fantasy-game-how-to-play'),
                                    fullscreenDialog: true));
                          },
                          ...
                          onTap: () {
                            Navigator.push(
                                ...
                                MaterialPageRoute(
                                    builder: (context) => WebViewWidget(
                                        title: 'About us',
                                        url: 'https://www.dream11.com/games/what-is-dream11'),
                                    fullscreenDialog: true));
                          },
                          ...
                          onTap: () {
                            Navigator.push(
                                ...
                                MaterialPageRoute(
                                    builder: (context) => WebViewWidget(
                                        title: 'Legality',
                                        url: 'https://www.dream11.com/about-us/legality'),
                                    fullscreenDialog: true));
                          },
                            ...
                            Navigator.push(
                                ...
                                MaterialPageRoute(
                                    builder: (context) => WebViewWidget(
                                        ...
                                        url: 'https://www.dream11.com/about-us/fairplay/'),
                                    fullscreenDialog: true));
                          },
